...
function create_D3() {
    ...
    sphere_list[1].position.set(2 * scale, 0, 0);
    sphere_list[2].position.set(scale, scale, 0);
    sphere_list[3].position.set(0, 2 * scale, 0);
    sphere_list[4].position.set(-scale, scale, 0);
    sphere_list[5].position.set(-2 * scale, 0, 0);
    sphere_list[6].position.set(-scale, -scale, 0);
    sphere_list[7].position.set(0,-2 * scale,0);
    sphere_list[8].position.set(scale, -scale, 0);
    sphere_list[9].position.set(0, 0, 2 * scale);
    ...
    sphere_list[14].position.set(0, 0, -2 * scale);
